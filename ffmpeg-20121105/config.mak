...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-memalign-hack --enable-static
prefix=/usr/local
...
EXTRALIBS=-ldl -lasound -lSDL -lm -pthread -lz -lrt 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
